...
Figure~\ref{chap03-fig05} shows the result.  Note that the x axis is not time, as in the previous figures, but population.  We can divide this curve in terms of four regimes of behavior:
...
Just below 14 billion, there is a population where net growth is 0, which means that the population does not change.  At this point, the population is in {\bf equilibrium}.

To find this equilibrium point, we can find the roots, or zeros, of this equation:

\[ \Delta p = \alpha p + \beta p^2 \]

where $\Delta p$ is net growth, $p$ is current population, and $\alpha$ and $\beta$ are the parameters of the model. 


\section{Reparameterizing}
