...
\caption{Total number of infected students as a function of the parameter \py{gamma}, for several values of \py{beta}.}
\label{chap13-fig03}
\end{figure}
...
\begin{figure}
\centerline{\includegraphics[width=3.5in]{figs/chap17-fig02.pdf}}
...
\begin{figure}
\centerline{\includegraphics[width=3.5in]{figs/chap18-fig02.pdf}}
\caption{Results Euler's method and Ralston's method.}
\label{chap18-fig02}
\end{figure}
...
Suppose we want to find the launch angle that maximizes {\bf range}, that is, the distance the ball travels in the air before landing.   We'll use a function in the \py{modsim} library, \py{maximize}, which takes a function and finds its maximum.
