...
We'll start with the quadratic model from Section~\ref{???}, which is based on this update function:
...
As an exercise, use WolframAlpha to solve the quadratic model, using either or both forms of parameterization.
