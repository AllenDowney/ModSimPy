...
#+BEGIN_SRC python :results file :noweb yes
  ...
  fig.figure.savefig('bikeshareplot')
  return 'bikeshareplot.png'  # required for figure to show below
#+END_SRC

#+RESULTS:
[[file:bikeshareplot.png]]
...
#+BEGIN_SRC python :results file :noweb yes
  ...
  fig.figure.savefig('legendtest.png')
...
#+BEGIN_SRC python :noweb yes :results file
  ...
  fig = bikeshare.history.plot()
  decorate(fig, loc=0)
  fig.figure.savefig('legendtest1.png')

  return 'legendtest1.png'  # required for figure to show below
#+END_SRC

#+RESULTS:
[[file:legendtest1.png]]
...
#+BEGIN_SRC python :noweb yes :results file
  ...
  fig.figure.savefig('legendtest2.png')

  return 'legendtest2.png'  # required for figure to show below
#+END_SRC

#+RESULTS:
[[file:legendtest2.png]]
...
#+BEGIN_SRC python :results file :noweb yes
  ...
  decorate(ax)
  ax.figure.savefig('runsteps.png')
